...
MODEL                = Simulacao_CubeSat_2U
MODULES              = rt_logging.c Simulacao_CubeSat_2U.c Simulacao_CubeSat_2U_capi.c Simulacao_CubeSat_2U_data.c Simulacao_CubeSat_2U_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging_mmi.c rtw_modelmap_utils.c raccel_main_new.c raccel_sup.c raccel_mat.c simulink_solver_api.c raccel_utils.c common_utils.c ext_svr.c updown.c ext_work.c rtiostream_interface.c rtiostream_tcpip.c rtiostream_utils.c
PRODUCT              = Simulacao_CubeSat_2U.exe
MAKEFILE             = Simulacao_CubeSat_2U.mk
...
MASTER_ANCHOR_DIR    = 
START_DIR            = D:/Faculdade/CubeSat/Matlab
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/raccel/Simulacao_CubeSat_2U \
...
rtiostream_utils.obj : C:\Program\ Files\Polyspace\R2020a\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
	$(CC) -c -Fo$(@F) $(CFLAGS) C:\Program\ Files\Polyspace\R2020a\toolbox\coder\rtiostream\src\utils/rtiostream_utils.c
